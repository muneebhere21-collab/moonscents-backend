...
import { u as useNavigate, d as useCart, b as useAuth, L as Link, T as Toaster$1 } from "./router-BW0LjCeT.js";
...
function Nav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 inset-x-0 z-50 transition-all duration-700 ${scrolled ? "backdrop-blur-xl bg-background/80 border-b border-border py-0" : "bg-transparent py-2"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-6 text-[10px] tracking-luxe uppercase text-silver-muted", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: link.to,
              ...
              children: [
                link.name,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 w-0 h-px bg-silver transition-all duration-500 group-hover:w-full" })
              ]
            },
            link.to
          )) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 md:gap-5 text-silver/90", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex items-center transition-all duration-500 ${searchOpen ? "w-32 md:w-64 opacity-100" : "w-0 opacity-0 overflow-hidden"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSearch, className: "w-full relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: searchOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4" })
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 min-w-[14px] h-3.5 px-1 flex items-center justify-center rounded-full bg-silver text-primary-foreground text-[8px] font-bold", children: count })
                ]
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `fixed inset-0 top-20 bg-background/95 backdrop-blur-2xl transition-all duration-500 z-40 md:hidden ${mobileMenuOpen ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full pointer-events-none"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-10 p-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 h-px w-20 bg-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: user ? "/account" : "/auth",
              ...
              children: user ? "Your Account" : "Sign In"
            }
          )
        ] }) })
      ]
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border mt-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 max-w-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl text-silver-gradient", children: "Moonscents" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-relaxed text-silver-muted", children: "Fragrances composed under a Karachi moon. Crafted in small batches, delivered across Pakistan and beyond." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-luxe uppercase text-silver mb-4", children: "Shop" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-silver-muted", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/collection", className: "hover:text-silver transition-silk", children: "All Fragrances" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/discovery-kit", className: "hover:text-silver transition-silk", children: "Discovery Set" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/collection", className: "hover:text-silver transition-silk", children: "Gifting" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-luxe uppercase text-silver mb-4", children: "House" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-silver-muted", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "hover:text-silver transition-silk", children: "Our Story" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hover:text-silver transition-silk", children: "Contact" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/policies", className: "hover:text-silver transition-silk", children: "Policies" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-luxe uppercase text-silver mb-4", children: "Social" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-silver-muted", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.instagram.com/moonscentofficial?igsh=MTl6ZWg4czh6b3JwZg==", target: "_blank", rel: "noopener noreferrer", className: "hover:text-silver transition-silk", children: "Instagram" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.facebook.com/share/1BpSPquJCD/?mibextid=wwXIfr", target: "_blank", rel: "noopener noreferrer", className: "hover:text-silver transition-silk", children: "Facebook" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://wa.me/923303965260", target: "_blank", rel: "noopener noreferrer", className: "hover:text-silver transition-silk", children: "WhatsApp" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 py-6 flex flex-col md:flex-row justify-between text-xs text-silver-muted tracking-wider", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Moonscents.pk — All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Composed in Pakistan · Shipped Worldwide" })
    ] }) })
  ] });
}
      ...
      motion.aside,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 h-20 border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-luxe uppercase text-silver", children: "Your Cart" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: closeCart, "aria-label": "Close cart", className: "text-silver-muted hover:text-silver transition-silk", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-6 py-6", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl text-silver-gradient", children: "Your cart is empty" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-silver-muted mt-3 tracking-wide", children: "Begin with a fragrance." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/collection",
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-6", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-24 bg-background overflow-hidden flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 mt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-silver-muted", children: [
                  item.ml,
                  "ml · PKR ",
                  item.price.toLocaleString()
                ] }),
                item.customSelection && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-silver italic text-silver-muted/80 leading-tight border-l border-silver/20 pl-3 py-1 mt-1", children: [
                  '"',
                  item.customSelection,
                  '"'
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 inline-flex items-center border border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setQty(item.slug, item.quantity - 1), className: "w-8 h-8 grid place-items-center text-silver-muted hover:text-silver", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-3 h-3" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 text-center text-xs text-silver", children: item.quantity }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setQty(item.slug, item.quantity + 1), className: "w-8 h-8 grid place-items-center text-silver-muted hover:text-silver", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-3 h-3" }) })
              ] })
            ] })
          ] }, item.slug)) }) }),
          items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border px-6 py-6 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-luxe uppercase text-silver-muted", children: "Subtotal" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl text-silver", children: [
                "PKR ",
                subtotal.toLocaleString()
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-silver-muted", children: "Shipping calculated at checkout. Cash on delivery available across Pakistan." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/checkout",
